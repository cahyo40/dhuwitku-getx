...
class BudgetTypeFormScreen extends GetView<BudgetCreateController> {
  const BudgetTypeFormScreen({super.key});
            ...
            return Expanded(
              child: Obx(
                () => YoButton(
                  ...
                  textColor: controller.budgetType.value == type
                      ? primaryColor
                      : textColor,
                  variant: controller.budgetType.value == type
                      ? YoButtonVariant.custom
                      : YoButtonVariant.ghost,
                  onPressed: () {
                    controller.onFilterCategories(type);
                  },
                ),
              ),
            );
